...
{
    static const char usage_container[] =
        "Usage: wine-container                          Start the container\n"
        "       wine-container --help                   Display this help and exit\n"
        "       wine-container --version                Output version information and exit";
...
int main( int argc, char *argv[] )
{
    ...
    fprintf( stderr, "wine-container: start....\n" );
    wine_init_container( argc, argv, error, sizeof(error) );
    fprintf( stderr, "wine-container: failed to initialize: %s\n", error );
    exit(1);
}
