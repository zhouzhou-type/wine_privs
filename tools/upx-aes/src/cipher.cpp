...
static mr_unsign32 aes_encrypt(aes* a,unsigned char *buff)
{
    int j,bytes;
...
void cipher_init(void* inst, unsigned len)
{
	aes a;
	char key[32];
	char iv[16];
...
void cipher_encrypt(void* inst,unsigned char* in, unsigned in_len, unsigned char* out, unsigned* out_len)
{
	aes a;
	unsigned i;
	unsigned char* t;
...
void cipher_decrypt(void* inst,unsigned char* in, unsigned in_len, unsigned char* out, unsigned* out_len)
{
	aes a;
	unsigned i;
	unsigned char* t;
