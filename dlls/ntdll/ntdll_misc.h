...
extern HANDLE thread_init_container(void) DECLSPEC_HIDDEN;
...
extern NTSTATUS WINAPI nt_to_unix_file_name_attr( const OBJECT_ATTRIBUTES *attr, ANSI_STRING *unix_name_ret,
                                           UINT disposition );
