...
#define ENUM_REQUEST_CASE(x)   case x: return(#x);
...
{  
    switch (num)  
    {  
        ENUM_REQUEST_CASE(REQ_new_process)
        ENUM_REQUEST_CASE(REQ_get_new_process_info)
        ENUM_REQUEST_CASE(REQ_new_thread)
        ENUM_REQUEST_CASE(REQ_get_startup_info)
        ENUM_REQUEST_CASE(REQ_init_process_done)
        ENUM_REQUEST_CASE(REQ_init_thread)
        ENUM_REQUEST_CASE(REQ_terminate_process)
        ENUM_REQUEST_CASE(REQ_terminate_thread)
        ENUM_REQUEST_CASE(REQ_get_process_info)
        ENUM_REQUEST_CASE(REQ_set_process_info)
        ENUM_REQUEST_CASE(REQ_get_thread_info)
        ENUM_REQUEST_CASE(REQ_get_thread_times)
        ENUM_REQUEST_CASE(REQ_set_thread_info)
        ENUM_REQUEST_CASE(REQ_get_dll_info)
        ENUM_REQUEST_CASE(REQ_suspend_thread)
        ENUM_REQUEST_CASE(REQ_resume_thread)
        ENUM_REQUEST_CASE(REQ_load_dll)
        ENUM_REQUEST_CASE(REQ_unload_dll)
        ENUM_REQUEST_CASE(REQ_queue_apc)
        ENUM_REQUEST_CASE(REQ_get_apc_result)
        ENUM_REQUEST_CASE(REQ_close_handle)
        ENUM_REQUEST_CASE(REQ_set_handle_info)
        ENUM_REQUEST_CASE(REQ_dup_handle)
        ENUM_REQUEST_CASE(REQ_open_process)
        ENUM_REQUEST_CASE(REQ_open_thread)
        ENUM_REQUEST_CASE(REQ_select)
        ENUM_REQUEST_CASE(REQ_create_event)
        ENUM_REQUEST_CASE(REQ_event_op)
        ENUM_REQUEST_CASE(REQ_query_event)
        ENUM_REQUEST_CASE(REQ_open_event)
        ENUM_REQUEST_CASE(REQ_create_keyed_event)
        ENUM_REQUEST_CASE(REQ_open_keyed_event)
        ENUM_REQUEST_CASE(REQ_create_mutex)
        ENUM_REQUEST_CASE(REQ_release_mutex)
        ENUM_REQUEST_CASE(REQ_open_mutex)
        ENUM_REQUEST_CASE(REQ_query_mutex)
        ENUM_REQUEST_CASE(REQ_create_semaphore)
        ENUM_REQUEST_CASE(REQ_release_semaphore)
        ENUM_REQUEST_CASE(REQ_query_semaphore)
        ENUM_REQUEST_CASE(REQ_open_semaphore)
        ENUM_REQUEST_CASE(REQ_create_file)
        ENUM_REQUEST_CASE(REQ_open_file_object)
        ENUM_REQUEST_CASE(REQ_alloc_file_handle)
        ENUM_REQUEST_CASE(REQ_get_handle_unix_name)
        ENUM_REQUEST_CASE(REQ_get_handle_fd)
        ENUM_REQUEST_CASE(REQ_get_directory_cache_entry)
        ENUM_REQUEST_CASE(REQ_flush)
        ENUM_REQUEST_CASE(REQ_lock_file)
        ENUM_REQUEST_CASE(REQ_unlock_file)
        ENUM_REQUEST_CASE(REQ_create_socket)
        ENUM_REQUEST_CASE(REQ_accept_socket)
        ENUM_REQUEST_CASE(REQ_accept_into_socket)
        ENUM_REQUEST_CASE(REQ_set_socket_event)
        ENUM_REQUEST_CASE(REQ_get_socket_event)
        ENUM_REQUEST_CASE(REQ_get_socket_info)
        ENUM_REQUEST_CASE(REQ_enable_socket_event)
        ENUM_REQUEST_CASE(REQ_set_socket_deferred)
        ENUM_REQUEST_CASE(REQ_alloc_console)
        ENUM_REQUEST_CASE(REQ_free_console)
        ENUM_REQUEST_CASE(REQ_get_console_renderer_events)
        ENUM_REQUEST_CASE(REQ_open_console)
        ENUM_REQUEST_CASE(REQ_get_console_wait_event)
        ENUM_REQUEST_CASE(REQ_get_console_mode)
        ENUM_REQUEST_CASE(REQ_set_console_mode)
        ENUM_REQUEST_CASE(REQ_set_console_input_info)
        ENUM_REQUEST_CASE(REQ_get_console_input_info)
        ENUM_REQUEST_CASE(REQ_append_console_input_history)
        ENUM_REQUEST_CASE(REQ_get_console_input_history)
        ENUM_REQUEST_CASE(REQ_create_console_output)
        ENUM_REQUEST_CASE(REQ_set_console_output_info)
        ENUM_REQUEST_CASE(REQ_get_console_output_info)
        ENUM_REQUEST_CASE(REQ_write_console_input)
        ENUM_REQUEST_CASE(REQ_read_console_input)
        ENUM_REQUEST_CASE(REQ_write_console_output)
        ENUM_REQUEST_CASE(REQ_fill_console_output)
        ENUM_REQUEST_CASE(REQ_read_console_output)
        ENUM_REQUEST_CASE(REQ_move_console_output)
        ENUM_REQUEST_CASE(REQ_send_console_signal)
        ENUM_REQUEST_CASE(REQ_read_directory_changes)
        ENUM_REQUEST_CASE(REQ_read_change)
        ENUM_REQUEST_CASE(REQ_create_mapping)
        ENUM_REQUEST_CASE(REQ_open_mapping)
        ENUM_REQUEST_CASE(REQ_get_mapping_info)
        ENUM_REQUEST_CASE(REQ_get_mapping_committed_range)
        ENUM_REQUEST_CASE(REQ_add_mapping_committed_range)
        ENUM_REQUEST_CASE(REQ_create_snapshot)
        ENUM_REQUEST_CASE(REQ_next_process)
        ENUM_REQUEST_CASE(REQ_next_thread)
        ENUM_REQUEST_CASE(REQ_wait_debug_event)
        ENUM_REQUEST_CASE(REQ_queue_exception_event)
        ENUM_REQUEST_CASE(REQ_get_exception_status)
        ENUM_REQUEST_CASE(REQ_continue_debug_event)
        ENUM_REQUEST_CASE(REQ_debug_process)
        ENUM_REQUEST_CASE(REQ_debug_break)
        ENUM_REQUEST_CASE(REQ_set_debugger_kill_on_exit)
        ENUM_REQUEST_CASE(REQ_read_process_memory)
        ENUM_REQUEST_CASE(REQ_write_process_memory)
        ENUM_REQUEST_CASE(REQ_create_key)
        ENUM_REQUEST_CASE(REQ_open_key)
        ENUM_REQUEST_CASE(REQ_delete_key)
        ENUM_REQUEST_CASE(REQ_flush_key)
        ENUM_REQUEST_CASE(REQ_enum_key)
        ENUM_REQUEST_CASE(REQ_set_key_value)
        ENUM_REQUEST_CASE(REQ_get_key_value)
        ENUM_REQUEST_CASE(REQ_enum_key_value)
        ENUM_REQUEST_CASE(REQ_delete_key_value)
        ENUM_REQUEST_CASE(REQ_load_registry)
        ENUM_REQUEST_CASE(REQ_unload_registry)
        ENUM_REQUEST_CASE(REQ_save_registry)
        ENUM_REQUEST_CASE(REQ_set_registry_notification)
        ENUM_REQUEST_CASE(REQ_create_timer)
        ENUM_REQUEST_CASE(REQ_open_timer)
        ENUM_REQUEST_CASE(REQ_set_timer)
        ENUM_REQUEST_CASE(REQ_cancel_timer)
        ENUM_REQUEST_CASE(REQ_get_timer_info)
        ENUM_REQUEST_CASE(REQ_get_thread_context)
        ENUM_REQUEST_CASE(REQ_set_thread_context)
        ENUM_REQUEST_CASE(REQ_get_selector_entry)
        ENUM_REQUEST_CASE(REQ_add_atom)
        ENUM_REQUEST_CASE(REQ_delete_atom)
        ENUM_REQUEST_CASE(REQ_find_atom)
        ENUM_REQUEST_CASE(REQ_get_atom_information)
        ENUM_REQUEST_CASE(REQ_set_atom_information)
        ENUM_REQUEST_CASE(REQ_empty_atom_table)
        ENUM_REQUEST_CASE(REQ_init_atom_table)
        ENUM_REQUEST_CASE(REQ_get_msg_queue)
        ENUM_REQUEST_CASE(REQ_set_queue_fd)
        ENUM_REQUEST_CASE(REQ_set_queue_mask)
        ENUM_REQUEST_CASE(REQ_get_queue_status)
        ENUM_REQUEST_CASE(REQ_get_process_idle_event)
        ENUM_REQUEST_CASE(REQ_send_message)
        ENUM_REQUEST_CASE(REQ_post_quit_message)
        ENUM_REQUEST_CASE(REQ_send_hardware_message)
        ENUM_REQUEST_CASE(REQ_get_message)
        ENUM_REQUEST_CASE(REQ_reply_message)
        ENUM_REQUEST_CASE(REQ_accept_hardware_message)
        ENUM_REQUEST_CASE(REQ_get_message_reply)
        ENUM_REQUEST_CASE(REQ_set_win_timer)
        ENUM_REQUEST_CASE(REQ_kill_win_timer)
        ENUM_REQUEST_CASE(REQ_is_window_hung)
        ENUM_REQUEST_CASE(REQ_get_serial_info)
        ENUM_REQUEST_CASE(REQ_set_serial_info)
        ENUM_REQUEST_CASE(REQ_register_async)
        ENUM_REQUEST_CASE(REQ_cancel_async)
        ENUM_REQUEST_CASE(REQ_get_async_result)
        ENUM_REQUEST_CASE(REQ_read)
        ENUM_REQUEST_CASE(REQ_write)
        ENUM_REQUEST_CASE(REQ_ioctl)
        ENUM_REQUEST_CASE(REQ_set_irp_result)
        ENUM_REQUEST_CASE(REQ_create_named_pipe)
        ENUM_REQUEST_CASE(REQ_get_named_pipe_info)
        ENUM_REQUEST_CASE(REQ_set_named_pipe_info)
        ENUM_REQUEST_CASE(REQ_create_window)
        ENUM_REQUEST_CASE(REQ_destroy_window)
        ENUM_REQUEST_CASE(REQ_get_desktop_window)
        ENUM_REQUEST_CASE(REQ_set_window_owner)
        ENUM_REQUEST_CASE(REQ_get_window_info)
        ENUM_REQUEST_CASE(REQ_set_window_info)
        ENUM_REQUEST_CASE(REQ_set_parent)
        ENUM_REQUEST_CASE(REQ_get_window_parents)
        ENUM_REQUEST_CASE(REQ_get_window_children)
        ENUM_REQUEST_CASE(REQ_get_window_children_from_point)
        ENUM_REQUEST_CASE(REQ_get_window_tree)
        ENUM_REQUEST_CASE(REQ_set_window_pos)
        ENUM_REQUEST_CASE(REQ_get_window_rectangles)
        ENUM_REQUEST_CASE(REQ_get_window_text)
        ENUM_REQUEST_CASE(REQ_set_window_text)
        ENUM_REQUEST_CASE(REQ_get_windows_offset)
        ENUM_REQUEST_CASE(REQ_get_visible_region)
        ENUM_REQUEST_CASE(REQ_get_surface_region)
        ENUM_REQUEST_CASE(REQ_get_window_region)
        ENUM_REQUEST_CASE(REQ_set_window_region)
        ENUM_REQUEST_CASE(REQ_get_update_region)
        ENUM_REQUEST_CASE(REQ_update_window_zorder)
        ENUM_REQUEST_CASE(REQ_redraw_window)
        ENUM_REQUEST_CASE(REQ_set_window_property)
        ...
        ENUM_REQUEST_CASE(REQ_create_winstation)
        ENUM_REQUEST_CASE(REQ_open_winstation)
        ENUM_REQUEST_CASE(REQ_close_winstation)
        ENUM_REQUEST_CASE(REQ_get_process_winstation)
        ENUM_REQUEST_CASE(REQ_set_process_winstation)
        ENUM_REQUEST_CASE(REQ_enum_winstation)
        ENUM_REQUEST_CASE(REQ_create_desktop)
        ENUM_REQUEST_CASE(REQ_open_desktop)
        ENUM_REQUEST_CASE(REQ_open_input_desktop)
        ENUM_REQUEST_CASE(REQ_close_desktop)
        ENUM_REQUEST_CASE(REQ_get_thread_desktop)
        ENUM_REQUEST_CASE(REQ_set_thread_desktop)
        ENUM_REQUEST_CASE(REQ_enum_desktop)
        ENUM_REQUEST_CASE(REQ_set_user_object_info)
        ENUM_REQUEST_CASE(REQ_register_hotkey)
        ENUM_REQUEST_CASE(REQ_unregister_hotkey)
        ENUM_REQUEST_CASE(REQ_attach_thread_input)
        ENUM_REQUEST_CASE(REQ_get_thread_input)
        ENUM_REQUEST_CASE(REQ_get_last_input_time)
        ENUM_REQUEST_CASE(REQ_get_key_state)
        ENUM_REQUEST_CASE(REQ_set_key_state)
        ENUM_REQUEST_CASE(REQ_set_foreground_window)
        ENUM_REQUEST_CASE(REQ_set_focus_window)
        ENUM_REQUEST_CASE(REQ_set_active_window)
        ENUM_REQUEST_CASE(REQ_set_capture_window)
        ENUM_REQUEST_CASE(REQ_set_caret_window)
        ENUM_REQUEST_CASE(REQ_set_caret_info)
        ENUM_REQUEST_CASE(REQ_set_hook)
        ENUM_REQUEST_CASE(REQ_remove_hook)
        ENUM_REQUEST_CASE(REQ_start_hook_chain)
        ENUM_REQUEST_CASE(REQ_finish_hook_chain)
        ENUM_REQUEST_CASE(REQ_get_hook_info)
        ENUM_REQUEST_CASE(REQ_create_class)
        ENUM_REQUEST_CASE(REQ_destroy_class)
        ENUM_REQUEST_CASE(REQ_set_class_info)
        ENUM_REQUEST_CASE(REQ_open_clipboard)
        ENUM_REQUEST_CASE(REQ_close_clipboard)
        ENUM_REQUEST_CASE(REQ_empty_clipboard)
        ENUM_REQUEST_CASE(REQ_set_clipboard_data)
        ENUM_REQUEST_CASE(REQ_get_clipboard_data)
        ENUM_REQUEST_CASE(REQ_get_clipboard_formats)
        ENUM_REQUEST_CASE(REQ_enum_clipboard_formats)
        ENUM_REQUEST_CASE(REQ_release_clipboard)
        ENUM_REQUEST_CASE(REQ_get_clipboard_info)
        ENUM_REQUEST_CASE(REQ_set_clipboard_viewer)
        ENUM_REQUEST_CASE(REQ_add_clipboard_listener)
        ENUM_REQUEST_CASE(REQ_remove_clipboard_listener)
        ENUM_REQUEST_CASE(REQ_open_token)
        ENUM_REQUEST_CASE(REQ_set_global_windows)
        ENUM_REQUEST_CASE(REQ_adjust_token_privileges)
        ENUM_REQUEST_CASE(REQ_get_token_privileges)
        ENUM_REQUEST_CASE(REQ_check_token_privileges)
        ENUM_REQUEST_CASE(REQ_duplicate_token)
        ENUM_REQUEST_CASE(REQ_access_check)
        ENUM_REQUEST_CASE(REQ_get_token_sid)
        ENUM_REQUEST_CASE(REQ_get_token_groups)
        ENUM_REQUEST_CASE(REQ_get_token_default_dacl)
        ENUM_REQUEST_CASE(REQ_set_token_default_dacl)
        ENUM_REQUEST_CASE(REQ_set_security_object)
        ENUM_REQUEST_CASE(REQ_get_security_object)
        ENUM_REQUEST_CASE(REQ_get_system_handles)
        ENUM_REQUEST_CASE(REQ_create_mailslot)
        ENUM_REQUEST_CASE(REQ_set_mailslot_info)
        ENUM_REQUEST_CASE(REQ_create_directory)
        ENUM_REQUEST_CASE(REQ_open_directory)
        ENUM_REQUEST_CASE(REQ_get_directory_entry)
        ENUM_REQUEST_CASE(REQ_create_symlink)
        ENUM_REQUEST_CASE(REQ_open_symlink)
        ENUM_REQUEST_CASE(REQ_query_symlink)
        ENUM_REQUEST_CASE(REQ_get_object_info)
        ENUM_REQUEST_CASE(REQ_get_object_type)
        ENUM_REQUEST_CASE(REQ_unlink_object)
        ENUM_REQUEST_CASE(REQ_get_token_impersonation_level)
        ENUM_REQUEST_CASE(REQ_allocate_locally_unique_id)
        ENUM_REQUEST_CASE(REQ_create_device_manager)
        ENUM_REQUEST_CASE(REQ_create_device)
        ENUM_REQUEST_CASE(REQ_delete_device)
        ENUM_REQUEST_CASE(REQ_get_next_device_request)
        ENUM_REQUEST_CASE(REQ_make_process_system)
        ENUM_REQUEST_CASE(REQ_get_token_statistics)
        ENUM_REQUEST_CASE(REQ_create_completion)
        ENUM_REQUEST_CASE(REQ_open_completion)
        ENUM_REQUEST_CASE(REQ_add_completion)
        ENUM_REQUEST_CASE(REQ_remove_completion)
        ENUM_REQUEST_CASE(REQ_query_completion)
        ENUM_REQUEST_CASE(REQ_set_completion_info)
        ENUM_REQUEST_CASE(REQ_add_fd_completion)
        ENUM_REQUEST_CASE(REQ_set_fd_disp_info)
        ENUM_REQUEST_CASE(REQ_set_fd_name_info)
        ENUM_REQUEST_CASE(REQ_get_window_layered_info)
        ENUM_REQUEST_CASE(REQ_set_window_layered_info)
        ENUM_REQUEST_CASE(REQ_alloc_user_handle)
        ENUM_REQUEST_CASE(REQ_free_user_handle)
        ENUM_REQUEST_CASE(REQ_set_cursor)
        ENUM_REQUEST_CASE(REQ_update_rawinput_devices)
        ENUM_REQUEST_CASE(REQ_get_suspend_context)
        ENUM_REQUEST_CASE(REQ_set_suspend_context)
        ENUM_REQUEST_CASE(REQ_create_job)
        ENUM_REQUEST_CASE(REQ_open_job)
        ENUM_REQUEST_CASE(REQ_assign_job)
        ENUM_REQUEST_CASE(REQ_process_in_job)
        ENUM_REQUEST_CASE(REQ_set_job_limits)
